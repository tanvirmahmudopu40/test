    ...
    function getPayment() {
        ...
        foreach ($data['payments'] as $payment) {
            ...
            if ($payment->payment_from == 'appointment') {
                $from = '<span class="label-warning">'.lang('appointment').'</span>';
            } elseif ($payment->payment_from == 'payment') {
                $from ='<span class="label-success">'. lang('payment').'</span>';
            }elseif ($payment->payment_from == 'admitted_patient_bed_medicine') {
                $from ='<span class="label-info">'. lang('admitted_patient_bed_medicine').'</span>';
            }elseif ($payment->payment_from == 'admitted_patient_bed_service') {
                $from ='<span class="label-success">'. lang('admitted_patient_bed_service').'</span>';
            }
